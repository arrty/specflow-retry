    ...
    public partial class SampleFeatureFeature
    {
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "SampleFeature", "  In order to avoid silly mistakes\r\n  As a math idiot\r\n  I want to be told the su" +
                    "m of two numbers", ProgrammingLanguage.CSharp, new string[] {
                        "retry:1"});
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("On except exception should not retry")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "SampleFeature")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("criticalException")]
        public virtual void OnExceptExceptionShouldNotRetry()
        {
            ...
            for (int i = 0; (i <= 1); i = (i + 1))
            {
                try
                {
                    this.OnExceptExceptionShouldNotRetryInternal();
                    return;
                }
                catch (SpecFlow.Retry.Sample.CriticalException exc)
                {
                    throw;
                }
                catch (System.Exception exc)
        ...
        private void OnExceptExceptionShouldNotRetryInternal()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("On except exception should not retry", new string[] {
